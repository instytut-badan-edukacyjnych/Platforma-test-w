...
/**
 * Klasa bazowa zmiany zadań
 *
 *
 */
public class ViewChangeBase {
    protected OnAnimationEnd onAnimationEnd;

    public ViewChangeBase(OnAnimationEnd onAnimationEnd) {
    ...
    public static interface OnAnimationEnd {
        public void animationEnded() throws IOException;
    }
}
