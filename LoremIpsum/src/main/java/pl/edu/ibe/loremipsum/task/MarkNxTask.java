...
/**
 * Klasa obsługi zadania pojegajacymna zanaczeniu kilku elementów na wspólnej
 * masce
 *
 *
 */
public class MarkNxTask extends Mark1xTask {
    private static final String TAG = MarkNxTask.class.toString();
     ...
     */
    public MarkNxTask(Context context) {
        super(context);
    }

    /*
     * (non-Javadoc)
     * @see pl.edu.ibe.loremipsum.task.Mark1xTask#Create(pl.edu.ibe.loremipsum.task.TaskInfo, android.os.Handler, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see pl.edu.ibe.loremipsum.task.Mark1xTask#TouchEvent(android.view.MotionEvent)
     */
    @Override
