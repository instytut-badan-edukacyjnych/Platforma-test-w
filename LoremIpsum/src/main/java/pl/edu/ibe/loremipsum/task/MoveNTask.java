 ...
 *
 */
public class MoveNTask extends MoveBaseTask {
    private static final String TAG = MoveNTask.class.toString();
     ...
     */
    public MoveNTask(Context context) {
        super(context);
    }
        ...
        if (m_document != null) {
            ...
            if (list != null) {
                if (list.getLength() > a_info.m_groupIndex) {
                    ...
                    if (map != null) {
                        Node node = map.getNamedItem(XML_DETAILS_TASK_PLACE);
                        if (node != null) {
                            ...
                            valid = false;
                            LogUtils.e(TAG, ERR_MESS_NO_FILE + XML_DETAILS_TASK_PLACE);
                        }
                        node = null;
                        ...
                        if (map != null) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    throw new Exception("Could not load file \"" + fileName + "\"", t);
                                }
                            } catch (Throwable t) {
                                bmp = null;
                                valid = false;
                                LogUtils.e(TAG, "Could not load bitmap from field " + XML_DETAILS_FIELD_MASK, t);
                            }
