 ...
 */
public class AggregateRule implements MappingRule {

    private Collection<MappingRule> rules;

    public AggregateRule(Collection<MappingRule> rules) {
        this.rules = rules;
    }
