...
/**
 * Marks task based on number of object in specified field
 *
 */
public class NumberArbiter extends ExternalArbiter {
    private static final String TAG = NumberArbiter.class.toString();
