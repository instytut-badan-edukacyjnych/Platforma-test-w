 ...
 */
public class AssetsSuiteTaskAccesor  extends AssetsTaskAccessor {
    public AssetsSuiteTaskAccesor(AssetManager assets, String assetName) {
        super(assets, AssetsTaskSuiteService.SUITES_DIR + File.separator + assetName);
    }
}
