...
/**
 * Klasa zmiany zadania przez zsuniecie
 *
 *
 */
public class ViewChangeScale extends ViewChangeBase {

    private TaskAct taskAct;

    public ViewChangeScale(OnAnimationEnd onAnimationEnd) {
...
//
//        final ObjectAnimator foreToback = ObjectAnimator.ofFloat(fore, "scaleX", 1.0f, 0.1f);
//        foreToback.setDuration(500);
//        foreToback.setInterpolator(taskAct.m_accelerator);
//
//        final ObjectAnimator backTofore = ObjectAnimator.ofFloat(back, "scaleX", 0.1f, 1.0f);
//        backTofore.setDuration(500);
//        backTofore.setInterpolator(taskAct.m_decelerator);
//
//        taskAct.m_backView.setScaleX(0.1f);
//
...
//                taskAct.m_foreView.setScaleX(1.0f);
//
//                backTofore.start();
//
