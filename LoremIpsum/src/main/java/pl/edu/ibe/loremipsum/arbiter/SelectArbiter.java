...
/**
 * Marks task based on specific item selection
 */
public class SelectArbiter extends ExternalArbiter {
//	private static final String TAG = "SelectArbiter";


    private final int APP_BAD_SELECT_SHIFT = 1000;
    ...
    public void Assess(Vector<BaseTask.FieldSelect> a_data, String a_answer) {
        ...
        int number = GetSelectNr(a_answer);
        int answer = Check(a_data, a_answer);

        if (answer < APP_BAD_SELECT_SHIFT) {
            if (answer == number) {
                m_mark = APP_MARK_1;
            } else {
                m_mark = APP_MARK_0;
    ...
    /*
     * (non-Javadoc)
     * @see pl.edu.ibe.loremipsum.arbiter.BaseArbiter#Assess(java.util.Vector, java.lang.String, int)
     */
    @Override
    ...
    /**
     * Checks item location on fields
     *
     * @param a_data   - information about task active fields
     * @param a_answer - correct answer string
     * @return number of correctly selected fields + APP_BAD_SELECT_SHIFT * number of wrongly selected fields
     */
    private int Check(Vector<BaseTask.FieldSelect> a_data, String a_answer) {
        ...
        return correctly + APP_BAD_SELECT_SHIFT * incorrectly;
    }

    /**
     * Specifies number on answer selection
     * @param a_answer - - correct answer string
     * @return number of answer selection
     */
    private int GetSelectNr(String a_answer) {
