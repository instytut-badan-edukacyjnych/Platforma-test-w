...
/**
 * Klaa obsługi zadania pojegajacymna zanaczeniu kilku elementów na wspólnej
 * masce
 *
 *
 */
public class MarkFlexNxTask extends MarkFlex1xTask {
    private static final String TAG = MarkFlexNxTask.class.toString();
     ...
     */
    public MarkFlexNxTask(Context context) {
        super(context);
    }

    /*
     * (non-Javadoc)
     * @see pl.edu.ibe.loremipsum.task.MarkFlex1xTask#Create(pl.edu.ibe.loremipsum.task.TaskInfo, android.os.Handler, java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see pl.edu.ibe.loremipsum.task.MarkFlex1xTask#TouchEvent(android.view.MotionEvent)
     */
    @Override
